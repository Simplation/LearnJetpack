...
import com.simplation.mvvmlib.base.activity.BaseVmActivity
import com.simplation.mvvmlib.base.fragment.BaseVmFragment
import com.simplation.mvvmlib.base.viewmodel.BaseViewModel
import com.simplation.mvvmlib.ext.util.loge
...
import com.simplation.mvvmlib.state.paresException
import com.simplation.mvvmlib.state.paresResult
 ...
 * @param block 请求体方法
 * @param resultState 请求回调的 ResultState 数据
...
/**
 * 过滤服务器结果，失败抛异常
 * @param block 请求体方法，必须要用 suspend 关键字修饰
 * @param success 成功回调
...
fun <T> BaseViewModel.request(
    ...
    // 如果需要弹窗 通知 Activity/fragment 弹窗
    return viewModelScope.launch {
        runCatching {
